...
const Route = () => {
  return (
    <div className="route-container">
      {/* <h1 className="route-header">Route and Timeline</h1> */}
        ...
        <div className="map-elements">
          <div className="map-keys">
            ...
            <p className="map-text">
              Initial route from Jax Beach to Cannon Beach <br /> Ten days from
              coast to coast{" "}
            </p>
          </div>
          <div className="map-keys">
            <img src={dot1} alt="" />
            <p className="map-text">
              Main backbone of the route <br /> The time spent in one place
              varied from one night to four weeks
            </p>
          </div>
          <div className="map-keys">
            <img src={dot3} alt="" />
            <p className="map-text">
              Weekend trips and noteable pit-stops
              <br /> Mt. Rainer • Lake Tahoe • Tetons • Zion
            </p>
          </div>
        </div>
      </div>
