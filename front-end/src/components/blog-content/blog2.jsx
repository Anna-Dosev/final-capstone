...
const Blog2 = () => {
  ...
  const navToPhotos = (e) => {
    ...
    return (
      ...
      <br></br><br></br>
      On my latest trip, I had one mission in mind: make it to Angel's Landing for sunrise. This presented a bit of a challenge, as the shuttles to the trailheads don't start until after the sun is up.
      So I rented an e-bike at 5:30 in the morning and rode into the park before it even opened. Guided only by my headlight, I followed the winding canyon road to the trail. It was an eerie feeling: knowing the contents of your surroundings but not being able to see it. 
      I could only tell where the sky was interrupted by the ridge lines because of the river shaped path of the stars—the Milky Way included. 
      <br></br><br></br>
