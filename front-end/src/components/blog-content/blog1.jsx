...
const Blog1 = () => {
  ...
  const navToPhotos = (e) => {
    ...
    return (
      ...
      opportunities to experience not only the rocky beaches and rugged cliffsides, but also the temperate rainforests that border them. The towering Douglas Firs, Ponderosa Pines and Sitka Spruces 
      guard much of the coastline and provide a dramatic backdrop against the sand and sky. 
      <br></br><br></br> 
