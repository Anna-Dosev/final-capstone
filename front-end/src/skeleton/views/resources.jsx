          ...
          return (
            <div className="result-item">
              ...
              <div className="result-item-info">
                <p onClick={() => setParkInfo(park)} className="result-text">
                  {park.name}
                </p>
              </div>
            </div>
      ...
      <div className="blog-item-container-2">
        ...
        <div className="blog-item-text">
          ...
          <p className="blog-content-text">
            Wrapping around Tillamook Head, between Seaside and Cannon Beach,
            Ecola State Park stretches along 9 miles of coastline and offers
            outstanding sightseeing and recreation opportunities combined with a
            storied past. Though the scenic and hiking opportunities may be the
            main allure, the diversity of outdoor recreation including
            picnicking, tidepooling, surfing and wildlife observation make Ecola
            State park a destination year round.
            <br></br>
            <br></br>
            Sightseeing opportunities begin the moment you enter the park. The
            entrance road meanders through a lush Sitka spruce forest,
            eventually opening up to a grassy bluff offering breathtaking views
            of the Pacific Ocean. You may recognize the viewpoint south, a scene
            from many published photographs. Sea stacks punctuate the long sweep
            of shoreline south, backed by the town of Cannon Beach and ridge of
            coastal mountains above.
            <br></br>
            <br></br>
            <a
              target="_blank"
              href="https://stateparks.oregon.gov/index.cfm?do=park.profile&parkId=136"
            >
              Learn more!
            </a>
          </p>
      ...
      <div className="np-container">
        <div className="np-search-save-container">
          <div className="np-search-container">
            ...
            <p className="np-inst-text">
              Find parks and places registered through the U.S. National Parks
              System.
              <br></br>
          ...
          <div className="result-info-container">
            {parkInfo && (
              <>
                ...
                <a href={parkInfo.url} target="_blank">
                  Learn More
                </a>
                <br></br> <br></br>
                <img
                  className="parkInfo-img"
                ...
                <img
                  className="parkInfo-img"
                  src={parkInfo.images[3].url}
                ></img>
              </>
            )}
          </div>
          <div className="result-item-container">{parks}</div>
        </div>
      </div>
    </div>
  );
